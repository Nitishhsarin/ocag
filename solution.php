...
else
{
	...
	if($subid!='')
	{
		include('./include/mysql_user.php');
	...
	<tr>
		<td>$subid</td>
		<td>$sub_timestamp</td>
		<td><a href='./problem.php?pcode=$sub_problemcode' style='text-decoration:none'>$sub_problemcode</a>
		<td><img src='./media/$sub_verdict.png'></td>
