...
else
{
	...
	if($status)
	{
		...
		{
			header("Location: ./../addtest.php?prev=partial&partialfailmsg=$errorstr_2<br> $errorstr_3");
		}
		else
		{
			header("Location: ./../addtest.php?prev=done");
		}
	}
	else
	{
		...
		mysqli_close($db);
	//	echo "$errorstr";
		header("Location: ./../addtest.php?prev=fail&msg=$errorstr");
	}
	;
}
?>
