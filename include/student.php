		...
		<tr>
			...
			<td class="right">
				<?php
					...
					{
						echo "<a href='./problem.php?pcode=$problemcode'>  $problemcode";
		...
		<tr>	
			<?php
				...
				{ 
					echo "
						<td>
							<a href='./studentregistration.php?edit=$rollno'>
						...
						<td>
							<a href='./passchange.php?user=$rollno'>
				...
				if($_SESSION['type']=="admin")
				{
					echo "
				 		<td>
							<form action='./functions/delstud.php' method='post'>
				...
				echo "<td><a href='./usersubmit.php?username=$rollno'><input type='button' value='Submissions' class='bbutton' ></a></td>";
				?>
