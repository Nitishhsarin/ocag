...
<?php 
	if($username!='')
	{
		...
		echo "
			<form method='post'  enctype='multipart/form-data' action='./functions/eval.php' onsubmit='return validate()'>
			";
		...
		echo "</select>
			...
			<td>
			<img src='./media/PENDING.png' id='hidden_running_gif' style='inline-display:block; display:none;'>
			</td>
			</tr>
		</table>
			</form>
