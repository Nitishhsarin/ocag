		...
		<tr>
			...
			<td class="right">
				<?php
					...
					{
						echo "  <a href='./facultygroup.php?groupid=$groupid'>$groupid</a>";
		...
		<tr>	
			<?php
				...
				{ 
					echo "
						<td>
							<a href='./facreg.php?edit=$facultyid'>
						...
						<td>
							<a href='./passchange.php?user=$facultyid'>
				...
				if($_SESSION['type']=="admin")
				{
					echo "
				 		<td>
							<form action='./functions/delfac.php' method='post'>
