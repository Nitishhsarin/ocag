...
<tr>
	...
	<td><?php echo "<a href='./faculty.php?facultyid=$createdby'>$createdby ";?></a></td>
...
<tr>
	...
	<td>
		<?php
			...
			{
				echo "<a href='./studentgroup.php?groupid=$groupid'>$groupid</a>  ";
			}
		?>
	</td>
</tr>
<tr>
	...
	<td>
		<?php
			...
			{
				echo "<a href='./problem.php?pcode=$probcode'>$probcode</a>  ";
			}
		?>
	</td>
</tr>
<tr>
<td>
<a href='./testattempt.php?testid=<?php echo $testid; ?>'>
...
<td>
<form action='./functions/testreset.php' method='post'>
...
<td>
<a href='./rankings.php?testid=<?php echo $testid; ?>'>
...
<tr>
<td>
<a href='./testsubmit.php?testid=<?php echo $testid; ?>'>
...
<td>
<form action='./functions/deltests.php' method='post'>
...
<td>
<a href='./addtest.php?edit=<?php echo $testid; ?>'>
