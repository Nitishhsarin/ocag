...
<h3>Manage Student Accounts</h3>
	<tr>
 	...
 	<tr>
<form  method='post'  action='./functions/delstud.php'  name='manage_accounts'>
				...
				<?php
					...
					while($r=mysqli_fetch_array($res))
					{
						...
						<td>
					 	...
					 	<td>
							<a href='./student.php?rollno=$rollno'>$rollno</a>
					 	</td>
						<td>
					  		<label>$fullname</label>
					 	</td>
						<td>
							<a href='./studentregistration.php?edit=$rollno'><img src='./media/edit.png'  onMouseOver=\"this.src='./media/edit_hover.png'\" onMouseOut=\"this.src='./media/edit.png'\"/></a>
				 		</td>
						</tr>
						";
						$i++;
