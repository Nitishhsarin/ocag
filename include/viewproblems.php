...
<h3>Manage Problems</h3>
	<tr>
 	...
 	<tr>
<form  method='post'  action='./functions/delprob.php'  name='manage_accounts'>
 			...
 			<table id='listtable'>
				...
				<?php
					...
					while($r=mysqli_fetch_array($res))
					{
						...
						<td>
							<a href='./faculty.php?facultyid=$addedby'>$addedby</a>
						</td>
						<td>
							<a href='./edit.php?edit=$problem_code'><img src='./media/edit.png'  onMouseOver=\"this.src='./media/edit_hover.png'\" onMouseOut=\"this.src='./media/edit.png'\"/></a>
				 		</td>
						</tr>
						";
						$i++;
