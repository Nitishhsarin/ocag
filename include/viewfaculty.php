...
<h3>Manage Faculty Accounts</h3>
	<tr>
 	...
 	<tr>
<form  method='post'  action='./functions/delfac.php'  name='manage_accounts'>
				...
				<?php
					...
					while($r=mysqli_fetch_array($res))
					{
						...
						<td>
					 	...
					 	<td>
							<a href='./faculty.php?facultyid=$facultyid'>$facultyid</a>
					 	</td>
						<td>
					  		<label>$fullname</label>
					 	</td>
						<td>
							<a href='./facreg.php?edit=$facultyid'><img src='./media/edit.png'  onMouseOver=\"this.src='./media/edit_hover.png'\" onMouseOut=\"this.src='./media/edit.png'\"/></a>
				 		</td>
						</tr>
						";
						$i++;
