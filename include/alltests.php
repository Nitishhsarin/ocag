...
<h3>Manage Tests</h3>
	<tr>
 	...
 	<tr>
<form  method='post'  action='./functions/deltests.php'  name='manage_tests'>
				...
				<?php
					...
					while($r=mysqli_fetch_array($res))
					{
						...
						<td>
					 	...
					 	<td>
							<a href='./viewtest.php?testid=$testid'>$testid</a>
					 	</td>
						<td>
						...
						<td>
							<a href='./addtest.php?edit=$testid'><img src='./media/edit.png'  onMouseOver=\"this.src='./media/edit_hover.png'\" onMouseOut=\"this.src='./media/edit.png'\"/></a>
				 		</td>
						</tr>
						";
